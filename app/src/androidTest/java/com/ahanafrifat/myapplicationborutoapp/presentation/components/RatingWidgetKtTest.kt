...
import com.ahanafrifat.myapplicationborutoapp.ui.theme.SMALL_PADDING
...
class RatingWidgetKtTest {
    ...
    fun passZeroPointZeroValue_Expect_FiveEmptyStars(){
        composeTestRule.setContent {
            RatingWidget(modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 0.0)
        }
    ...
    @Test
    fun passZeroPointFiveValue_Expect_FourEmptyStars_and_OneHalfFilledStar(){
        composeTestRule.setContent {
            RatingWidget(modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 0.5)
        }
    ...
    @Test
    fun passZeroPointSixValue_Expect_FourEmptyStars_and_OneHalfFilledStar(){
        composeTestRule.setContent {
            RatingWidget(modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 0.6)
        }
    ...
    @Test
    fun passFourPointZeroValue_Expect_FourFilledStars_and_OneEmptyStar(){
        composeTestRule.setContent {
            RatingWidget(modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 4.0)
        }
    ...
    @Test
    fun passFourPointThreeValue_Expect_FourFilledStars_and_OneHalfFilledStar(){
        composeTestRule.setContent {
            RatingWidget(modifier = Modifier.padding(all = SMALL_PADDING),
                rating = 4.3)
        }
