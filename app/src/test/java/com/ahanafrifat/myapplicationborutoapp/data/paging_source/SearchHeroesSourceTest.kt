...
import com.ahanafrifat.myapplicationborutoapp.data.remote.FakeBorutoApi
...
class SearchHeroesSourceTest {
    ...
    @Test
    fun `Search api with existing hero name, assert empty hero list and LoadingResult_Page`() =
        runTest {
